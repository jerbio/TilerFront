...
namespace TilerFront
{
    public static class WebApiConfig
    {
        ...
        /*
        public static Models.SubCalEvent ToSubCalEvent(this SubCalendarEvent SubCalendarEventEntry, CalendarEvent CalendarEventEntry=null)
        {
        ...
        public static Models.CalEvent ToCalEvent(this CalendarEvent CalendarEventEntry, TimeLine Range = null)
        {
